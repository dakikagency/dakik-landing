...
export function FAQ() {
	...
	return (
		<section className="relative bg-white text-black" id="faq">
			<div className="w-full px-[clamp(1.5rem,6vw,6rem)] py-[clamp(6rem,12vh,10rem)]">
				<div className="grid grid-cols-12 gap-x-8 gap-y-12 lg:gap-x-12">
					<header className="col-span-12 min-w-0 lg:col-span-5 lg:sticky lg:top-24 lg:self-start">
						...
						<h2 className="mt-5 font-black text-[clamp(2.75rem,5vw,5.5rem)] uppercase leading-[0.85] tracking-[-0.04em]">
							Frequently
							<br />
							asked.
						</h2>
